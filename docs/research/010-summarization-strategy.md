...
**Newton's answer: Both, in layers.**
...
class Summarizer:
    ...
    def episode_summary(self, episode) -> str:
        ...
        # "3-hour session with Tim designing Newton's storage architecture. Decided on Postgres + pgvector. Key insight: unified storage beats multi-service."
